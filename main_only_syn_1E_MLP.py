            ...
            for x_true1, x_true2 in self.dataloader:
                ...
                for s in range(self.batch_size):
                    ...
                    if self.args.policy == "greedy":
                        index, worst_index = greedy_policy_Smax_discount_worst(self.z_dim, mu_s.view([1,-1]), logvar_s.view([1,-1]), alpha=self.omega)
                        #print("step {}, sample {}, best latents {}".format(step, s, index))
                        #print("step {}, sample {}, worstlatents {}".format(step, s, worst_index))
                        c.update(index)
                        d.update(worst_index)
